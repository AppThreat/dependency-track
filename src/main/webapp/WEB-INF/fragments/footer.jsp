...
<script type="text/javascript" src="<c:url value="/assets/bootstrap-table/extensions/editable/bootstrap-table-editable.min.js"/><%=VERSION_PARAM%>"></script>
<script type="text/javascript" src="<c:url value="/assets/bootstrap3-editable/js/bootstrap-editable.min.js"/><%=VERSION_PARAM%>"></script>
