...
<link rel="stylesheet" type="text/css" href="<c:url value="/assets/bootstrap3-editable/css/bootstrap-editable.css"/>">
<link rel="stylesheet" type="text/css" href="<c:url value="/assets/fonts/opensans/opensans.css"/>">
<link rel="stylesheet" type="text/css" href="<c:url value="/assets/fonts/dotfont/dotfont.css"/>">
...
<link rel="stylesheet" type="text/css" href="<c:url value="/assets/toastr/toastr.min.css"/>">
