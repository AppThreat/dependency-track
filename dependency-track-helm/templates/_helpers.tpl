...
*/}}
{{- define "dependency-track.serviceIP" -}}
...
{{/*
Return the proper dependency-track image name
*/}}
{{- define "dependency-track.image" -}}
...
*/}}
{{- define "dependency-track.host" -}}
{{- if .Values.deptrackHost -}}
{{- $host := printf "%s%s" .Values.deptrackHost .Values.deptrackHost -}}
{{- default (include "dependency-track.serviceIP" .) $host -}}
{{- else -}}
{{- default (include "dependency-track.serviceIP" .) "" -}}
{{- end -}}
{{- end -}}
...
*/}}
{{- define "dependency-track.storageClass" -}}
{{/*
Helm 2.11 supports the assignment of a value to a variable defined in a different scope,
